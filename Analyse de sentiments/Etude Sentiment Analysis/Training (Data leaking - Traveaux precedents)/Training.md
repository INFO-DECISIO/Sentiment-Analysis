...
![png](Training_files/Training_18_3.png)
...
![png](Training_files/Training_18_5.png)
...
![png](Training_files/Training_18_7.png)
...
![png](Training_files/Training_21_1.png)
...
![png](Training_files/Training_24_1.png)
    



    
![png](Training_files/Training_24_2.png)
...
![png](Training_files/Training_32_1.png)
...
![png](Training_files/Training_32_3.png)
...
![png](Training_files/Training_32_5.png)
...
![png](Training_files/Training_32_7.png)
...
![png](Training_files/Training_34_1.png)
...
![png](Training_files/Training_36_1.png)
...
```
    ...
    ~\AppData\Local\Temp\ipykernel_5340\421897764.py in ?()
          4 best_overall_model_name = all_results_df.index[0]
          5 best_overall_model_type = all_results_df.loc[best_overall_model_name, 'Type']
          6 print(f"\nMeilleur modèle global identifié : {best_overall_model_name} ({best_overall_model_type})")
          7 
    ----> 8 if best_overall_model_type == 'Text Only':
          9     best_pipeline = results_text_only[best_overall_model_name]['model']
         10     X_shap = X_test[text_feature]
         11     pipeline_preprocessing_step = best_pipeline.steps[0][1] # Le TF-IDF
...
```
    ...
    Probabilités prédites : [0.14042545 0.78174465 0.0778299 ]
    Probabilité pour la classe prédite (1): 0.7817
    Prédiction Encodée: 1 -> Label: positive, Valeur: 1
    Sentiment prédit (Text + Metadata): {'label': 'positive', 'value': 1}
    
    Prédiction pour (Text + Metadata): {'cleaned_text': 'great meet morn twitter', 'Platform': 'Twitter', 'Time of Tweet': 'morning'}
    Modèle chargé depuis : sentiment_model_text_metadata.joblib
    Probabilités prédites : [0.37612484 0.57729693 0.04657823]
    Probabilité pour la classe prédite (1): 0.5773
    Prédiction Encodée: 1 -> Label: positive, Valeur: 1
    Sentiment prédit (Text + Metadata): {'label': 'positive', 'value': 1}
